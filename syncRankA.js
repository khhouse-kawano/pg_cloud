...
import { PostRank} from './postRank.js'
...
(async () => {
    ...
    const date = new Date();
    console.log(`start searching at ${date}`);
  ...
  // ログイン
    ...
    for( let i = 0; i < listPage ; i ++){
        ...
        for ( let e = 0; e < maxList; e ++){
            ...
            for (let l = 0; l < 150; l++){
                ...
                let formattedValue = listVlaue.replace(/\n/g, '\\n');
    ...
    writeFileSync(`databaseRank${ rank.name }.csv`, csv);
